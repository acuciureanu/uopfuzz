...
export function generateSingleReport(results, config) {
  ...
  md += `| Taint tracking | ES6 Proxy deep property interception (Schwartz et al., IEEE S&P 2010) |\n`;
  md += `| Risk scoring | CVSS v3.1-aligned base metrics (FIRST, 2019) |\n`;
  md += `| Strategy selection | Thompson Sampling with Beta posteriors (Thompson, 1933) |\n`;
  md += `| Gadget taxonomy | Silent Spring classification (Shcherbakov et al., USENIX 2023) |\n`;
  md += '\n';
